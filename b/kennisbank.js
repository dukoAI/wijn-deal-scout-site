...
(function () {
  ...
  function werkChipsBij(filters) {
    ...
    // Het bulletin-ontwerp heeft geen inklapbaar filterpaneel, dus dit element hoeft er
    // niet te zijn. Zonder deze guard stopt het hele script en filtert er niets meer.
    if (samenvatting) samenvatting.textContent = aantalFilters ? aantalFilters + ' actief' : 'geen actief';
